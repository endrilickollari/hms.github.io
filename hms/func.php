...
<html lang="en">
  ...
  <a class="navbar-brand" href="admin-panel.php"><i class="fa fa-user-plus" aria-hidden="true"></i> Our Hospital</a>
                  ...
                  <div class="col-md-8">
                   <select name="doctor" class="form-control" >
                     <option value="Dr. 1">Dr. 1</option>
                      ...
                      <option value="Dr. 2">Dr. 3</option>
                      <option value="Dr. 2">Dr. 4</option>
                      <option value="Dr. 2">Dr. 5</option>
                      <?php display_docs();?>
                    </select>
                  </div><br><br>
