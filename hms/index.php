...
<html lang="en">
  ...
  <body style="background:url('images/back2.jpg') repeat 0 0 fixed; background-size: cover;">
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:black;">
      <div class="row">
